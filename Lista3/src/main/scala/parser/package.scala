...
package object parser {
  ...
  def syntaxError(input: String, pos: Int, exp: Set[String]) = {
    ...
    sys.error("erro de sintaxe na linha " + lin + " e coluna " + col + ", esperado: " + exp.mkString(", "))
  } 
...
//  pop: operacao entre os dois
  ...
  val num: Parser[(Double, Int)] = for {
    ...
    } yield (((h :: t).mkString + dec).toDouble, pos), "numeral")
  } yield res
